...
import com.example.checklo.adapters.ChatMessageRecyclerAdapter;
import com.example.checklo.adapters.ChatroomRecyclerAdapter;
import com.example.checklo.models.ChatMessage;
import com.example.checklo.models.Chatroom;
...
public class ChatroomActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mMessage = findViewById(R.id.send_text);

        mChatMessageRecyclerView = findViewById(R.id.chatmessage_recycler_view);

        findViewById(R.id.send_button).setOnClickListener(this);
        findViewById(R.id.chatroom_tab).setOnClickListener(this);
    ...
    private void setChatroomName(){
        mChatroomTitle = findViewById(R.id.chatroom_title);
        mChatroomTitle.setText(mChatroom.getTitle());
    }
